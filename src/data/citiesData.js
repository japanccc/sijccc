...
export const cities = [
  ...
  },
  {
    ...
    events: `
      ※ 4月26日：ピクニック（バレー・バド）@万博記念公園
      ※ 5月17日：アスレチック
      ※ 5月23日〜24→LTCキャンプ
      ※ 6月28日：映画ピザパーティー
      ※ 6月20日→夏ミッションチームの伝道イベント
      ※ 7月11日：スペシャルacts`,
  ...
  },
  {
    ...
    image: nagoyaImage,
    logo: nagoyaLogo,
    description: "名古屋大学や南山大学、東海地区のさまざまな大学から集まった学生達とアットホームな集会を行っています。",
    events: `
        ※ 集会は毎週金曜日18時半から20時半
        ※ 場所は第2,4,5週の金曜はMUSTARD SEED クリスチャン教会で
        ※ 第1,3週の金曜は2箇所使える場所があって
        ※ 名古屋セントラル教会かニューハートチャーチのどちらかで集まります。
        ※ 新歓BBQが4月12日(土)に平和公園で11時からあります!`,
  ...
  },
  {
    ...
    events: `
      ※ 通常の集会：4/10から木曜日 19-2100 九州東部キリスト教会
      ※ 新歓の特別なイベントの予定（日程・場所・内容）：暫定 4/26 海の中道海浜公園 ピクニック`,
